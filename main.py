...
#
# # from game_view import GameView  # Still commented — we'll use when ready
#
...
#     {
#         "name": "security",
#         "type": "SECURITY",  # We'll update boot_sequence.py to handle this soon
...
#     # Change this line to test different terminals instantly
#     terminal_to_show = "mother"  # ← Just change this string: "mother" or "security"
#
...
#         )
#         window.show_view(arcade.View())  # Empty view to prevent crash
#         arcade.run()
#         return
#
#     arcade.run()
